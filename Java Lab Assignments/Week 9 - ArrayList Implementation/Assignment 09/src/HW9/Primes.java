...
public class Primes
{
    ...
    public static void main(String args[])
    {
        ...
        while(!candidates.isEmpty())
        {
            ...
            System.out.println("The prime no. discovered is : " + prime);
            primes.add(prime);
     ...
     * 
     * 
     //This function implements the SIEVE OF ERATOSTHENES method to find composites. 
     */
    public static void getComposites(ListInterface<Integer> candidates, ListInterface<Integer> composites, Integer prime)
    {
    	...
    	{
    		//removing all the nos that are the multiples of the currently discovered prime
    		if(candidates.getEntry(i) % prime == 0)
    		{
    			//adding the no in the composite list by removing from the candidate list
