...
class AList<T> implements ListInterface<T> {
    ...
    private T[] list; //Array of list entries;           -->IMP == ignore list[0]
    ...
    */
    public void reverse()
    {
    	...
    	//This method reverses the Array implementation of a list.
    	...
    	//A->B->C->D->null;        
    	 ...
    	 {
    		 /*take ith entry from start and swap it with the (n-i)th entry from the end*/
