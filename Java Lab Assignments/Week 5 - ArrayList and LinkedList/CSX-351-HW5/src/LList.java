    ...
    */
    ...
    {       	
    	...
    	//Complete this method.
    	 ...
    	 Node temp=firstNode , nodeBefore=null, nodeAfter;
         
         while(temp!=null)
         {
      	   nodeAfter=temp.getNextNode();                 //next=curr->next
      	   temp.setNextNode(nodeBefore);                 //curr->next=prev
      	   nodeBefore=temp;                              //prev=curr
      	   temp=nodeAfter;                               //curr=next
    ...
    public void cycle() 
    {
    	...
    	temp2=getNodeAt(numberOfEntries-1);
